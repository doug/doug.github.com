...
public class focusonly extends PApplet {
...
public void drawSpheres(PGraphics pg, int camid) {
  pg.background(255);
  pg.noStroke();
...
//  addAndDraw();
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "focusonly" });
  }
}
